...
<head>
	...
	<title>DIU BBDMS | Admin Dashboard</title>

	<!-- Font design link here -->
...
?>
	...
	<!-- Loading Scripts of here adding -->
	...
	window.onload = function(){
		...
		// Pie Chart from doughutData working Here
		var doctx = document.getElementById("chart-area3").getContext("2d");
		window.myDoughnut = new Chart(doctx).Pie(doughnutData, {responsive : true});

		// Dougnut Chart from doughnutData here working
